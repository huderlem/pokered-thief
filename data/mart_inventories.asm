...
ViridianMartText6:: ; 2442 (0:2442)
	db $FE,4,THIEF_BALL,ANTIDOTE,PARLYZ_HEAL,BURN_HEAL,$FF

; Pewter
PewterMartText1:: ; 2449 (0:2449)
	db $FE,7,THIEF_BALL,POTION,ESCAPE_ROPE,ANTIDOTE,BURN_HEAL,AWAKENING
	db PARLYZ_HEAL,$FF

; Cerulean
CeruleanMartText1:: ; 2453 (0:2453)
	db $FE,7,THIEF_BALL,POTION,REPEL,ANTIDOTE,BURN_HEAL,AWAKENING
	db PARLYZ_HEAL,$FF
...
VermilionMartText1:: ; 2461 (0:2461)
	db $FE,6,THIEF_BALL,SUPER_POTION,ICE_HEAL,AWAKENING,PARLYZ_HEAL
	db REPEL,$FF

; Lavender
LavenderMartText1:: ; 246a (0:246a)
	db $FE,9,THIEF_BALL,SUPER_POTION,REVIVE,ESCAPE_ROPE,SUPER_REPEL
	db ANTIDOTE,BURN_HEAL,ICE_HEAL,PARLYZ_HEAL,$FF

; Celadon Dept. Store 2F (1)
CeladonMart2Text1:: ; 2476 (0:2476)
	db $FE,9,THIEF_BALL,SUPER_POTION,REVIVE,SUPER_REPEL,ANTIDOTE
...
FuchsiaMartText1:: ; 24a8 (0:24a8)
	db $FE,5,THIEF_BALL,SUPER_POTION,REVIVE,FULL_HEAL
	db SUPER_REPEL,$FF

; unused? 24b1
	db $FE,5,THIEF_BALL,HYPER_POTION,SUPER_POTION,FULL_HEAL,REVIVE,$FF

; Cinnabar
CinnabarMartText1:: ; 24b9 (0:24b9)
	db $FE,6,THIEF_BALL,HYPER_POTION,MAX_REPEL,ESCAPE_ROPE
	db FULL_HEAL,REVIVE,$FF

; Saffron
SaffronMartText1:: ; 24c3 (0:24c3)
	db $FE,6,THIEF_BALL,HYPER_POTION,MAX_REPEL,ESCAPE_ROPE,FULL_HEAL
	db REVIVE,$FF

; Indigo
IndigoPlateauLobbyText4:: ; 24cc (0:24cc)
	db $FE,6,THIEF_BALL,FULL_RESTORE,MAX_POTION,FULL_HEAL
